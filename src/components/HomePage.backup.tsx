...
// Typing paragraph driven by scroll (plays forward/back with scroll)
const TypingParagraph: React.FC = () => {
  ...
  useEffect(() => {
    const unsub = scrollYProgress.on('change', (v) => {
      ...
      const len = Math.round(fullText.length * clamped)
      setDisplayed(fullText.slice(0, len))
    })
    return () => unsub()
  }, [scrollYProgress, fullText])
  ...
  return (
    <p
      ref={containerRef}
      className="text-xl md:text-3xl leading-relaxed text-gray-300 font-semibold"
      aria-live="polite"
    >
      {displayed}
      <span
        className="inline-block w-[10px] ml-1"
...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    // ensure start at first card on (re)enter without sync setState
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-white">
      ...
      {/* Header is now global via RootLayout */}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              {/* Toggle + contenuto mutuamente esclusivo */}
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed text-lg">
                              ...
                              formati fino ad un massimale di (50×70 cm)
                              consente una maggiore varietà di scelta per quanto
                              riguarda la gamma di colori (PANTONE - RAL -
                              TOYOINK).
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed text-lg">
                              ...
                              inoltre una maggiore rapidità d&apos;esecuzione,
                              la possibilità di effettuare lavorazioni con dato
          ...
          <div className="bg-black/90 border border-white/10 rounded-3xl shadow-2xl overflow-hidden">
            <div className="grid md:grid-cols-2 gap-0 items-stretch">
              ...
              <div className="p-6 md:p-12">
                ...
                {/* Description - typing on desktop, static on mobile */}
                {isMobile ? (
                  <p className="text-lg md:text-2xl leading-relaxed text-gray-300">
                    La nostra filosofia è quella di accompagnare il Cliente
                    attraverso tutte le fasi del processo creativo partendo da
                    una semplice bozza fino ad arrivare al mockup definitivo del
                    prodotto.
                  </p>
                ) : (
                  <TypingParagraph />
              ...
              {/* Visual Side: immagine con micro-animazione */}
              <motion.div
