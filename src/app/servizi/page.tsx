          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
            ...
            >
              <motion.div
                ...
                className="w-32 h-32 bg-gradient-to-br from-[#C6D92E] to-[#B8C526] rounded-full flex items-center justify-center text-white text-5xl font-bold shadow-lg"
              >
                LC
              </motion.div>
            </motion.div>
